...
The social web translator. Fetches and converts data between social networks, HTML with [microformats2](http://microformats.org/wiki/microformats2), [mf2json](http://microformats.org/wiki/mf2json), [ActivityStreams](http://activitystrea.ms/)/[ActivityPub](https://activitypub.rocks/), [Atom](https://tools.ietf.org/html/rfc4287), [JSON Feed](https://jsonfeed.org/), and more.
...
* HTML with [microformats2](http://microformats.org/wiki/microformats2) including [h-feed](http://microformats.org/wiki/h-feed), and [mf2json](http://microformats.org/wiki/mf2json)
